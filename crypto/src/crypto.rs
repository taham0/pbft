...
// Generate Keys 
// use crypto::ed25519::Keypair::generate().{public(), secret()} to
// generate keys
// Codec
// use self.encode() to serialize
// use crypto::ed25519::PublicKey::decode() to deserialize
pub const ED25519_PK_SIZE:usize = 32;
// Codec
// use self.to_bytes() to serialize
// use crypto::ed25519::SecretKey::from_bytes to deserialize
